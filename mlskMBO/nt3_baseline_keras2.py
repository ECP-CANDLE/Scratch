...
def read_config_file(file):
    ...
    params = [ 'data_url', 'train_data', 'test_data', 'model_name', 'conv',
               'dense', 'activation', 'out_act', 'loss', 'optimizer',
               'metrics', 'epochs', 'batch_size', 'learning_rate', 'drop',
               'classes', 'pool', 'save' ]
    
    fileParams = { param : eval(config.get(section[0], param)) for param in params }
...
#model.add(Activation('softmax'))
    ...
    if False:
        ...
        with open('{}/{}.model.json'.format(output_dir, model_name), 'r') as json_file:
        ...
        with open('{}/{}.model.yaml'.format(output_dir, model_name), 'r') as yaml_file:
